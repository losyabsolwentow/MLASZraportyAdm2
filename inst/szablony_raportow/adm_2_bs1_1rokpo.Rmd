...
cat(
  ...
  params$rok,
  " roku (według stanu na 31 grudnia 2021 roku).\n\n* Dane pozyskane z Zakładu Ubezpieczeń Społecznych obejmują okres od 1 stycznia 2021 roku do 10 maja 2021 roku. Informują o rejestrowanej przez ZUS aktywności zawodowej ",
...
* uzupełnieniu raportów o informacje na temat branż, w których podjęli naukę w branżowych szkołach II stopnia absolwenci wykształceni w Państwa szkole w poszczególnych zawodach (o ile liczebność grup wyróżnionych ze względu na wyuczony zawód na to pozwala),

* uproszczeniu sposobu prezentacji sytuacji absolwentów poprzez zmniejszenie liczby statusów odzwierciedlających ich sytuację edukacyjną i zawodową z sześciu do czterech; kategoria “uczy się i brak informacji o sytuacji zawodowej” została dołączona do kategorii “uczy się i nie pracuje”, a kategoria “nie uczy się i brak informacji o sytuacji zawodowej” do kategorii “nie uczy się i nie pracuje”,
...
if (szk$S3_12[[1]]$n >= progLiczebnosci & nrow(tab_s3_zaw_check) > 0) {
  ...
  for (i in tab_s3_zaw_check$typ) {
    ...
    tab_god$typ = "Absolwenci pozostałych BS I"
    ...
    tabela = rbind(tab_szk, tab_god) %>% 
      ...
      kable_styling(position = wyrownanieTabWykr,
                    ...
                    full_width = TRUE,
                    repeat_header_text = "(ciąg dalszy tabeli)") %>% 
      add_header_above(c(i, "1" = 1, "2" = 1, "3" = 1, "4" = 1),
                       align = c("l", "c", "c", "c", "c")) %>%
      add_header_above(c(" ",
...
if (szk$Z4_ucz[[1]]$n >= progLiczebnosci) {
  cat(
    ...
    params$rok,
    " roku.\n\nDla kontynuujących naukę absolwentów pozostałych branżowych szkół I stopnia z ",
    powiaty_dop,
...
if (szk$Z8_formy_ucz[[1]]$n >= progLiczebnosci) {
  ...
  levels(tab_wyk$typ) = linebreak(levels(tab_wyk$typ))
...
TO JESZCZE DO PRZEGADANIA CZY DZIELIMY NA UCZ I NIE UCZ
...
if (szk$W3_nie_ucz[[1]]$n >= progLiczebnosci) {
  cat(
    ...
    "% średnich wynagrodzeń mieszkańców powiatów, w których mieszkali.\n\nDla pracujących na etat i kontynuujących edukację absolwentów pozostałych branżowych szkół I stopnia z ",
    powiaty_dop,
...
Procentowy udział grup wyróżnionych ze względu na formę wykonywania pracy wśród pracujących absolwentów barnżowych szkół I stopnia z całego kraju.
