...
*Raport roczny z monitoringu karier absolwentów, których szkołą ukończoną w `r params$rok` roku była `r szk$dane_szkoly[[1]]$nazwa`. Monitoring na podstawie danych rejestrowych. Warszawa: Instytut Badań Edukacyjnych, 2022.*
...
if (szk$Z8_formy_ucz[[1]]$n >= progLiczebnosci) {
  ...
  wyk_tyt = wrapper(paste0("Wykres ",
                           wyk_num(),
                           ": Formy wykonywania pracy przez pracujących absolwentów Państwa szkoły oraz pozostałych branżowych szkół I stopnia z ",
                           powiaty_dop,
                           ", w grudniu ",
                           params$rok,
                           " roku - kontynuujący naukę"),
...
if (szk$Z9_mlod_ucz[[1]]$n >= progLiczebnosci) {
  ...
  wykres = wykres_poziomy_statusy(tab_wyk, wyk_tyt) +
    scale_fill_manual(values = c("#d62f26", # czerwony
                                 "#fb8c59")) # pomarańczowy
