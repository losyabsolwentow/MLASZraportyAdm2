...
Pierwsza edycja monitoringu karier dotyczyła wyłącznie absolwentów szkół kształcących zawodowo. W niniejszej edycji po raz pierwszy przygotowano raporty również dla liceów ogólnokształcących dla młodzieży oraz liceów ogólnokształcących dla dorosłych. Żeby zwiększyć przydatność raportów, po rozważaniu uwag zgłoszonych przez dyrektorów szkół, nauczycieli i doradców zawodowych, wprowadziliśmy zmiany w stosunku do pierwszej edycji. Polegają one przede wszystkim na:
