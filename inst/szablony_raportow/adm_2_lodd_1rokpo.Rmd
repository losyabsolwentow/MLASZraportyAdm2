...
*Raport roczny z monitoringu karier absolwentów, których szkołą ukończoną w `r params$rok` roku było `r szk$dane_szkoly[[1]]$nazwa`. Monitoring na podstawie danych rejestrowych. Warszawa: Instytut Badań Edukacyjnych, 2022.*
...
if (length(szk$Z4_nie_ucz[[1]]) > 0) {
  if (szk$Z4_nie_ucz[[1]]$n >= progLiczebnosci) {
    cat(
      "W okresie od września do grudnia ",
      params$rok,
      " roku absolwenci Państwa szkoły, którzy nie byli wtedy studentami ani uczniami szkoły policealnej, pracowali średnio w ciągu ",
...
if (szk$Z8_formy_ucz[[1]]$n >= progLiczebnosci) {
  ...
  wyk_tyt = wrapper(paste0("Wykres ",
                           wyk_num(),
                           ": Formy wykonywania pracy przez pracujących absolwentów Państwa szkoły oraz pozostałych liceów ogólnokształcących dla dorosłych z ",
                           powiaty_dop,
                           ", w grudniu ",
                           params$rok,
                           " roku - kontynuujący naukę"),
