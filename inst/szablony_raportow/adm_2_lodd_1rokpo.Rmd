...
if (length(szk$liczebnosc_dziedziny) > 0) {
...
if (length(szk$Z4_ucz[[1]]) > 0) {
  if (szk$Z4_ucz[[1]]$n >= progLiczebnosci) {
    ...
    wykres = wyk_facet(tab_wyk,
                       wrapper(paste0("Wykres ",
                                      wyk_num(),
                                      ": Procentowy udział grup wyróżnionych ze względu na część przepracowanego okresu wśród absolwentów Państwa szkoły oraz absolwentów pozostałych liceów ogólnokształcących dla dorosłych z ",
                                      powiaty_dop,
...
if (szk$Z8_formy_ucz[[1]]$n >= progLiczebnosci) {
  ...
  wyk_tyt = wrapper(paste0("Wykres ",
                           wyk_num(),
                           ": Formy wykonywania pracy przez absolwentów Państwa szkoły oraz pozostałych liceów ogólnokształcących dla dorosłych z ",
                           powiaty_dop,
                           ", w grudniu ",
                           params$rok,
                           " roku - kontynuujący naukę"),
