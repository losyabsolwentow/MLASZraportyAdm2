...
if (szk$E2_nauka_kontyn[[1]]$n >= progLiczebnosci) {
  ...
  if (sposoby != 0) {
    ...
    cat("Żaden z absolwentów Państwa szkoły z rocznika ",
        ...
        " w grudniu ",
        params$rok,
        " roku nie kontynuował nauki w kolejnej szkole ponadpodstawowej, na Kwalifikacyjnym Kursie Zawodowym ani na Kursie Umiejętności Zawodowych.",
        sep = "")
  }
} else {
...
if (szk$Z4_ucz[[1]]$n >= progLiczebnosci) {
  cat(
    "Absolwenci Państwa szkoły, którzy uczyli się w szkole specjalnej przysposabiającej do pracy, pracowali średnio w ciągu ",
...
if (szk$Z4_nie_ucz[[1]]$n >= progLiczebnosci) {
  cat(
    ...
    "% tego okresu. Dla niekontynuujących nauki w szkole ponadpodstawowej absolwentów pozostałych szkół specjalnych przysposabiających do pracy z ",
    powiaty_dop,
    " średnia arytmetyczna odsetka przepracowanych miesięcy wyniosła ",
  ...
  cat("Liczba absolwentów Państwa szkoły nie kontynuujących nauki w kolejnej szkole ponadpodstawowej nie była wystarczająca, żeby możliwe było przedstawienie wyników dla tej grupy, zgodnie z zasadą chroniącą anonimowość absolwentów.\n\n")
}
```
...
if (szk$Z8_formy_ucz[[1]]$n >= progLiczebnosci) {
  ...
  cat("Liczba absolwentów Państwa szkoły pracujących i kontynuujących naukę w kolejnej szkole ponadpodstawowej nie była wystarczająca, żeby możliwe było przedstawienie wyników dla tej grupy, zgodnie z zasadą chroniącą anonimowość absolwentów.\n\n")
}
```
...
if (szk$Z8_formy_ucz[[1]]$n >= progLiczebnosci) {
  ...
  wyk_tyt = wrapper(paste0("Wykres ",
                           wyk_num(),
                           ": Formy wykonywania pracy przez pracujących absolwentów Państwa szkoły oraz pozostałych szkół specjalnych przysposabiających do pracy z ",
                           powiaty_dop,
                           ", w grudniu ",
                           params$rok,
                           " roku - kontynuujący naukę"),
...
if (szk$Z8_formy_nie_ucz[[1]]$n >= progLiczebnosci) {
  ...
  cat(
    "Spośród pracujących absolwentów Państwa szkoły, którzy nie kontynuowali nauki w kolejnej szkole ponadpodstawowej, w grudniu ",
    params$rok,
    " roku dla ",
  ...
  cat("Liczba absolwentów Państwa szkoły pracujących i niekontynuujących nauki w kolejnej szkole ponadpodstawowej nie była wystarczająca, żeby możliwe było przedstawienie wyników dla tej grupy, zgodnie z zasadą chroniącą anonimowość absolwentów.\n\n")
}
```
...
if (szk$W3_nie_ucz[[1]]$n >= progLiczebnosci) {
  ...
  cat("Liczba absolwentów Państwa szkoły pracujących na etat i niekontynuujących nauki w kolejnej szkole ponadpodstawowej nie była wystarczająca, żeby możliwe było przedstawienie wyników dla tej grupy, zgodnie z zasadą chroniącą anonimowość absolwentów.")
}
```
...
W aneksie zaprezentowano tabelaryczne rozkłady wybranych wskaźników przedstawionych w raporcie, ale dla ogółu absolwentów, którzy w roku szkolnym `r rocznik` ukończyli szkoły specjalne przysposabiające do pracy w całym kraju.
...
3. Praca po ukończeniu szkoły specjalnyej przysposabiającej do pracy w okresie od września do grudnia `r params$rok` roku
...
Procentowy udział grup wyróżnionych ze względu na formę wykonywania pracy wśród pracujących absolwentów szkół przysposabiających do pracy z całego kraju.
