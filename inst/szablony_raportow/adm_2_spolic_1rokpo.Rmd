...
if (szk$S3_12[[1]]$n >= progLiczebnosci) {
  ...
  wykres_poziomy_statusy(tab,
                       wrapper(paste0("Wykres ",
                                      wyk_num(),
                                      ": Status edukacyjno-zawodowy absolwentów Państwa szkoły oraz pozostałych szkół policealnych w grupach odniesienia, w grudniu ",
                                      params$rok,
                                      " roku - ogółem"), 80))
}
```
...
if (szk$W1_ucz[[1]]$n >= progLiczebnosci) {
  ...
  wyk_tyt = wrapper(paste0("Wykres ",
                           wyk_num(),
                           ": Miesięczne przychody brutto z pracy absolwentów Państwa szkoły oraz pozostałych szkół policealnych w ",
                           odmiany$god_dop,
                           " i w kraju, od września do grudnia ",
                           params$rok,
...
if (szk$W1_nie_ucz[[1]]$n >= progLiczebnosci) {
  cat(
    "Niekontynuujący nauki w szkole ponadpodstawowej absolwenci Państwa szkoły, którzy przez co najmniej część okresu od września do grudnia ",
    params$rok,
...
if (szk$W1_nie_ucz[[1]]$n >= progLiczebnosci) {
  ...
  wyk_tyt = wrapper(paste0("Wykres ",
                           wyk_num(),
                           ": Miesięczne przychody brutto absolwentów Państwa szkoły oraz pozostałych szkół policealnych w ",
                           odmiany$god_dop,
                           " i w kraju, od września do grudnia ",
                           params$rok,
