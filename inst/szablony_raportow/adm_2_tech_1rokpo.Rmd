---
title: |
  | Raport roczny z monitoringu karier absolwentów, którzy ukończyli technikum w roku szkolnym `r params$rok - 1`/`r params$rok`
subtitle: |
...
* uproszczeniu sposobu prezentacji sytuacji absolwentów poprzez zmniejszenie liczby statusów odzwierciedlających ich sytuację edukacyjną i zawodową z sześciu do czterech; kategoria “uczy się i brak informacji o sytuacji zawodowej” została połączona z kategorią  “uczy się i nie pracuje na podstawie umowy o pracę ani samozatrudnienia”, a kategoria “nie uczy się i brak informacji o sytuacji zawodowej” kategorią “nie uczy się i nie pracuje”,
...
if (szk$S3_12[[1]]$n >= progLiczebnosci) {
  cat(
    ...
    "%, podczas gdy spośród absolwentów pozostałych techników z ",
    powiaty_dop,
    " ",
...
if (szk$S3_12[[1]]$n >= progLiczebnosci) {
  if (nrow(tab_s3_zaw_check) > 0) {
    ...
    for (i in tab_s3_zaw_check$typ) {
      ...
      tab_god$typ = paste0("Pozostałe technika\nz ", powiaty_dop)
...
if (length(szk$dyscypliny_zawody[[1]]) > 1 & l_col > 0) {
  ...
  cat("\n\n**Tabela ",
      ...
      ":** Dyscypliny, w których absolwenci Państwa szkoły najczęściej studiowali w grudniu ",
      params$rok,
      " roku - w grupach wyróżnionych ze względu na zawód wyuczony w technikum (%)",
      sep = "")
...
if (length(szk$Z4_ucz[[1]]) > 0) {
  if (szk$Z4_ucz[[1]]$n >= progLiczebnosci) {
    cat(
      ...
      params$rok,
      " roku. Dla kontynuujących naukę absolwentów pozostałych techników z ",
      powiaty_dop,
...
if (length(szk$Z4_nie_ucz[[1]]) > 0) {
  if (szk$Z4_nie_ucz[[1]]$n >= progLiczebnosci) {
    cat(
      ...
      "% tego okresu. Dla niekontynuujących nauki na uczelni ani w szkole policealnej absolwentów pozostałych techników z ",
      powiaty_dop,
      " średnia arytmetyczna odsetka przepracowanych miesięcy wyniosła ",
...
if (szk$W3_nie_ucz[[1]]$n >= progLiczebnosci) {
  cat(
    ...
    "% średnich wynagrodzeń mieszkańców powiatów, w których mieszkali.\n\nDla pracujących na etat i niekontynuujących edukacji absolwentów pozostałych techników z ",
    powiaty_dop,
